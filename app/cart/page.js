        ...
        <>
          <div className="max-w-xl mx-auto px-4 py-3 flex items-center justify-between">
            <button
              ...
              <div
                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors ${isAllSelected ? "bg-black border-black" : "border-gray-300"}`}>
                {isAllSelected && (
                  <svg
